...
const noticeCreateInputTitle = document.getElementById("notice-create-input-title");
const noticeCreateInputDescription = document.getElementById("notice-create-input-description");
const noticeCreateBtn = document.getElementById("notice-create-btn");
const examCreateInputSubject = document.getElementById("exam-create-input-subject");
const examType = document.getElementById("exam-type");
const examCrateInputDate = document.getElementById("exam-create-input-date");
const examCreateInputDescription = document.getElementById("exam-create-input-description");
...
const updateExamList = () => {
    fetch("/examData").then(res => res.json()).then(data => {
        if (data) {
