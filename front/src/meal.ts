...
const todayMeal = document.getElementById("today-meal") as HTMLElement
const today = document.getElementById("today-md") as HTMLElement
const todayMealInfo = document.getElementById("today-meal-info") as HTMLElement
fetch("/mealData").then(
    res => res.json()
).then(data => {
    if(data) {
